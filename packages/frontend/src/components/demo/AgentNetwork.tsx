...
const AgentNode = ({ position, label, color = '#00ff88' }: { position: readonly [number, number, number] | [number, number, number], label: string, color?: string }) => {
...
const Connection = ({ start, end }: { start: readonly [number, number, number] | [number, number, number], end: readonly [number, number, number] | [number, number, number] }) => {
