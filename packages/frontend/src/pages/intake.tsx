...
export default function IntakePage() {
  ...
  const [demoCallStatus, setDemoCallStatus] = useState<'idle' | 'calling' | 'success' | 'error'>('idle');
  ...
  async function handleDemoCall() {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to initiate demo call. Please try again.');
    } finally {
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Enter your name and phone above, then click to receive a live demo call from our AI.
                  </p>
                </div>
                <button
                  type="button"
