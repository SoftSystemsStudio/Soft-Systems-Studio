  ...
  return (
    <div className="fixed inset-0 -z-10">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 30% 20%, rgba(192, 255, 107, 0.15) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(168, 85, 247, 0.1) 0%, transparent 50%)',
        }}
      />
    ...
    <div className="bg-gray-900/70 border border-gray-800 rounded-2xl p-8 backdrop-blur-sm">
      ...
      <div className="mt-8 grid grid-cols-2 gap-4">
        <div className="bg-black/50 rounded-xl p-4 text-center">
          <div className="text-3xl font-bold text-[#c0ff6b]">${annualSavings.toLocaleString()}</div>
          <div className="text-xs text-gray-500 mt-1">Annual Savings</div>
        </div>
        <div className="bg-black/50 rounded-xl p-4 text-center">
          <div className="text-3xl font-bold text-[#c0ff6b]">{roi.toFixed(0)}%</div>
  ...
  const features = [
    {
      ...
      description: 'Never miss a call. AI answers 24/7, books appointments, answers FAQs.',
    },
    {
      icon: '💬',
      title: 'Smart Chatbot',
      description: 'Intelligent chat that learns your business and converts visitors to leads.',
    },
    {
      icon: '⚡',
      title: 'Workflow Automation',
      description: 'Connect your tools. Automate repetitive tasks. Save 10+ hours weekly.',
    },
    {
      icon: '📊',
      title: 'Live Analytics',
      description: 'Real-time dashboards showing exactly how AI is impacting your business.',
    },
    {
      icon: '🔗',
      title: 'Deep Integrations',
      description: 'Connects with your CRM, calendar, email, and 100+ other tools.',
    },
    {
      icon: '🛡️',
      title: 'Enterprise Security',
      description: 'SOC 2 compliant. Your data is encrypted and never used for training.',
    },
  ];
    ...
    <div className="min-h-screen text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 p-4 backdrop-blur-md bg-black/30 border-b border-gray-800/50">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link
            href="/"
            className="text-[#c0ff6b] font-mono font-bold text-lg hover:opacity-80 transition-opacity"
          >
            ← SOFT SYSTEMS
          </Link>
          <MagneticButton
        ...
        <div className="text-center max-w-4xl">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
              Voice AI, chatbots, and automation that actually understand your business. No
              templates. No limitations. Just results.
            </p>
      ...
      <section id="features" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-lg">Enterprise-grade AI, small business pricing</p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
              Join 50+ businesses already saving time and money with our AI solutions. 30-day
