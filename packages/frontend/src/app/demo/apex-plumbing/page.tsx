...
/* ─── data ─── */
const services = [
  { title: 'Emergency Repairs', desc: 'Burst pipes, leaks, and overflows handled fast — day or night.', icon: '🚨' },
  { title: 'Water Heater Service', desc: 'Tankless & traditional installs, repairs, and maintenance.', icon: '🔥' },
  ...
  { title: 'Pipe Installation', desc: 'New construction, repiping, and gas line work.', icon: '🔧' },
  { title: 'Fixture Replacement', desc: 'Sinks, toilets, faucets — expert install guaranteed.', icon: '🚰' },
];

const reviews = [
  { name: 'Sarah M.', rating: 5, text: 'They came out within an hour on a Sunday and fixed our burst pipe. Incredible service — I\'ll never call anyone else.', date: 'Dec 2025' },
  { name: 'James R.', rating: 5, text: 'Upfront pricing, fast work, and the technician even cleaned up after. This is how every service company should operate.', date: 'Jan 2026' },
  { name: 'Maria L.', rating: 5, text: 'We had a slab leak that two other companies couldn\'t find. Apex located and fixed it in one day. Worth every penny.', date: 'Nov 2025' },
  { name: 'David K.', rating: 5, text: 'Replaced our 20-year-old water heater with a tankless unit. Professional, on-time, and the price was exactly what they quoted.', date: 'Feb 2026' },
];

const serviceAreas = ['Austin', 'Round Rock', 'Cedar Park', 'Pflugerville', 'Georgetown', 'Lakeway', 'Bee Cave', 'Leander', 'Dripping Springs', 'Kyle', 'Buda', 'Manor'];
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans antialiased">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="#" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <div className="text-[10px] text-orange-500/80 font-semibold tracking-[0.2em] uppercase -mt-0.5">Austin, Texas</div>
            </div>
          </a>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/10 border border-orange-500/20 rounded-full mb-8">
                ...
                <span className="text-orange-400 text-sm font-semibold tracking-wide">AVAILABLE NOW — 24/7 EMERGENCY SERVICE</span>
              </div>
              ...
              <p className="text-lg md:text-xl text-gray-400 mb-10 leading-relaxed max-w-lg">
                Licensed &amp; insured with 500+ five-star reviews. Same-day service, upfront pricing, and a 100% satisfaction guarantee — every time.
              </p>
                ...
                <div className="aspect-[4/5] rounded-3xl bg-gradient-to-br from-orange-500/20 via-orange-600/10 to-transparent border border-white/5 overflow-hidden relative">
                  ...
                  <div className="absolute bottom-8 left-8 right-8 bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-xl bg-orange-500/20 flex items-center justify-center text-2xl">⭐</div>
                      <div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <Reveal>
            <div className="text-center mb-16">
              <div className="text-orange-500 text-sm font-bold tracking-[0.2em] uppercase mb-4">What We Do</div>
              <h2 className="text-4xl md:text-5xl font-black mb-4">Professional Plumbing Services</h2>
              <p className="text-gray-400 max-w-xl mx-auto">From emergency repairs to full installations — we handle every plumbing need with precision and care.</p>
            </div>
          </Reveal>
            ...
            {services.map((service, i) => (
              <Reveal key={service.title} delay={i * 0.08}>
                <div className="group relative p-8 rounded-2xl border border-white/5 bg-white/[0.02] hover:border-orange-500/30 hover:bg-orange-500/[0.03] transition-all duration-500 cursor-default">
                  ...
                  <h3 className="text-xl font-bold mb-3 group-hover:text-orange-500 transition-colors duration-300">{service.title}</h3>
      ...
      <section className="py-24 md:py-32 bg-gradient-to-b from-transparent via-orange-950/5 to-transparent">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal>
            <div className="text-center mb-16">
              <div className="text-orange-500 text-sm font-bold tracking-[0.2em] uppercase mb-4">Our Work</div>
              <h2 className="text-4xl md:text-5xl font-black mb-4">Before &amp; After</h2>
              <p className="text-gray-400 max-w-xl mx-auto">See the transformations we deliver for Austin homeowners every day.</p>
            </div>
          </Reveal>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { label: 'Kitchen Repiping', before: 'from-red-900/40 to-red-950/60', after: 'from-emerald-600/30 to-emerald-900/50' },
              { label: 'Water Heater Install', before: 'from-amber-900/40 to-stone-900/60', after: 'from-sky-500/30 to-sky-900/50' },
              { label: 'Drain Restoration', before: 'from-stone-700/40 to-stone-900/60', after: 'from-orange-500/30 to-amber-700/50' },
            ].map((project, i) => (
              <Reveal key={project.label} delay={i * 0.15}>
                <div className="group cursor-default">
                  <div className="grid grid-cols-2 gap-2 mb-4">
                    <div className={`aspect-[4/3] rounded-xl bg-gradient-to-br ${project.before} border border-white/5 flex items-center justify-center`}>
                      <span className="text-xs font-bold text-white/40 uppercase tracking-wider">Before</span>
                    </div>
                    <div className={`aspect-[4/3] rounded-xl bg-gradient-to-br ${project.after} border border-white/5 flex items-center justify-center`}>
                      <span className="text-xs font-bold text-white/40 uppercase tracking-wider">After</span>
                    </div>
                  </div>
                  <h4 className="font-bold text-lg group-hover:text-orange-500 transition-colors duration-300">{project.label}</h4>
      ...
      <section id="reviews" className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal>
            <div className="text-center mb-16">
              <div className="text-orange-500 text-sm font-bold tracking-[0.2em] uppercase mb-4">Testimonials</div>
            ...
            {reviews.map((review, i) => (
              <Reveal key={review.name} delay={i * 0.1}>
                <div className="p-8 rounded-2xl border border-white/5 bg-white/[0.02] hover:border-orange-500/20 transition-all duration-500 group">
                  <div className="flex text-orange-500 text-lg mb-4">{'★'.repeat(review.rating)}</div>
                  <p className="text-gray-300 leading-relaxed mb-6 italic">&ldquo;{review.text}&rdquo;</p>
          ...
          <Reveal delay={0.4}>
            <div className="text-center mt-12">
              <a href="#" className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 rounded-xl text-sm font-medium hover:border-orange-500/30 hover:text-orange-500 transition-all duration-300">
      ...
      {/* ───────── SERVICE AREA ───────── */}
      <section id="areas" className="py-24 md:py-32 bg-gradient-to-b from-transparent via-orange-950/5 to-transparent">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div>
                <div className="text-orange-500 text-sm font-bold tracking-[0.2em] uppercase mb-4">Service Areas</div>
                <h2 className="text-4xl md:text-5xl font-black mb-6">Serving Greater Austin</h2>
                <p className="text-gray-400 mb-10 leading-relaxed">
                  From downtown Austin to the surrounding suburbs, our trucks are always nearby and ready to roll. Most service calls answered within 60 minutes.
                </p>
            ...
            <Reveal delay={0.2}>
              <div className="relative aspect-square rounded-3xl bg-gradient-to-br from-orange-950/20 via-black to-orange-950/10 border border-white/5 overflow-hidden">
                ...
                <div className="absolute inset-0">
                  ...
                  {/* Scattered dots */}
                  {[
                    { t: '30%', l: '35%' }, { t: '25%', l: '55%' }, { t: '40%', l: '65%' },
                    { t: '55%', l: '30%' }, { t: '65%', l: '50%' }, { t: '60%', l: '70%' },
                    { t: '35%', l: '45%' }, { t: '70%', l: '40%' }, { t: '45%', l: '55%' },
                  ].map((pos, i) => (
                    <div
                      key={i}
      ...
      <section id="about" className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal>
            <div className="text-center mb-16">
              <div className="text-orange-500 text-sm font-bold tracking-[0.2em] uppercase mb-4">Why Apex</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { num: '01', title: 'We Show Up Fast', desc: 'Average response time under 60 minutes. Emergency? We prioritize you.' },
              { num: '02', title: 'We Price It Fair', desc: 'You approve the price before we start. No hidden fees, no surprise charges.' },
              { num: '03', title: 'We Guarantee It', desc: 'Not happy? We\'ll make it right — free of charge. Period.' },
            ].map((item, i) => (
              <Reveal key={item.num} delay={i * 0.15}>
                <div className="relative p-10 rounded-2xl border border-white/5 bg-white/[0.01] group hover:border-orange-500/20 transition-all duration-500">
                  <div className="text-6xl font-black text-white/[0.03] absolute top-6 right-8 group-hover:text-orange-500/10 transition-colors duration-500">{item.num}</div>
                  <div className="relative">
      ...
      <section className="py-24 md:py-32 relative overflow-hidden">
        ...
        <Reveal>
          <div className="relative max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-4xl md:text-6xl font-black mb-6 text-black">Need a Plumber<br />Right Now?</h2>
            <p className="text-xl text-black/70 mb-10 max-w-lg mx-auto">
              Don&apos;t wait for water damage to get worse. Call now and we&apos;ll have a licensed technician at your door fast.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center font-black text-black text-lg">A</div>
                <div className="text-xl font-black">APEX PLUMBING</div>
              </div>
              <p className="text-gray-500 text-sm leading-relaxed mb-6">
                Austin&apos;s trusted plumbing professionals. Licensed, insured, and committed to excellence since 2015.
              </p>
              <div className="flex gap-3">
                {['𝕏', 'f', 'in'].map((social) => (
                  <a key={social} href="#" className="w-9 h-9 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center text-sm text-gray-400 hover:border-orange-500/30 hover:text-orange-500 transition-all duration-300">
                    {social}
                  </a>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {services.slice(0, 4).map((s) => (
                  <a key={s.title} href="#services" className="block text-sm text-gray-500 hover:text-orange-500 transition-colors duration-300">{s.title}</a>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {['About Us', 'Reviews', 'Service Areas', 'Careers', 'Blog'].map((link) => (
                  <a key={link} href="#" className="block text-sm text-gray-500 hover:text-orange-500 transition-colors duration-300">{link}</a>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-gray-500">
                <a href="tel:512-555-2739" className="block hover:text-orange-500 transition-colors duration-300">📞 (512) 555-2739</a>
                <a href="#" className="block hover:text-orange-500 transition-colors duration-300">✉️ info@apexplumbing.com</a>
                <p>📍 Austin, TX 78701</p>
                <div className="pt-2">
          ...
          <div className="border-t border-white/5 pt-10 mb-10">
            <div className="flex flex-wrap items-center justify-center gap-8">
              {['BBB A+ Rated', 'TX Licensed #M-41205', 'Fully Insured', 'EPA Certified', 'HomeAdvisor Top Rated'].map((cert) => (
                <div key={cert} className="px-4 py-2 rounded-lg border border-white/5 text-xs text-gray-500 font-medium hover:border-orange-500/20 transition-colors duration-300">
                  {cert}
                </div>
              ))}
            </div>
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-600 text-xs">© 2026 Apex Plumbing. All rights reserved. This is a demo site.</p>
            <Link
              href="/#web-design"
