...
const products = [
  {
    ...
    category: 'keyboards',
    img: '⌨️',
    desc: 'Mechanical RGB keyboard with hot-swappable switches, PBT keycaps, and per-key lighting. Built for competitive gaming.',
    specs: [
  ...
  },
  {
    ...
    category: 'mice',
    img: '🖱️',
    desc: 'Ultra-lightweight 58g gaming mouse with 25K DPI sensor, PTFE feet, and flexible paracord cable.',
    specs: [
  ...
  },
  {
    ...
    category: 'audio',
    img: '🎧',
    desc: '7.1 surround sound wireless headset with 50mm drivers, memory foam pads, and 40hr battery life.',
    specs: [
  ...
  },
  {
    ...
    img: '🖥️',
    desc: 'Extended RGB mousepad with micro-textured surface, non-slip rubber base, and 16.8M color edge lighting.',
    specs: [
      '900x400mm extended size',
      'Micro-textured cloth surface',
      '16.8M color RGB edge',
  ...
  },
  {
    ...
    category: 'streaming',
    img: '📷',
    desc: '4K 60fps webcam with auto-focus, HDR, and AI-powered noise cancellation for professional streams.',
    specs: [
      '4K @ 60fps capture',
      'Auto-focus with face tracking',
      'HDR & low-light correction',
  ...
  },
  {
    ...
    category: 'monitors',
    img: '🖥️',
    desc: '27" 1440p 240Hz IPS gaming monitor with 1ms response time, G-Sync compatible, and HDR600.',
    specs: [
      '2560x1440 IPS panel',
      '240Hz refresh rate',
      '1ms GtG response',
  ...
  },
  {
    ...
    category: 'accessories',
    img: '🎮',
    desc: 'Wireless controller with Hall-effect triggers, mechanical bumpers, and remappable back buttons.',
    specs: [
  ...
  },
  {
    ...
    category: 'streaming',
    img: '🔲',
    desc: '6-key customizable LCD stream deck for OBS, Twitch, and productivity macros.',
    specs: [
...
const reviews = [
  ...
  },
  {
    ...
    avatar: '👩‍🎮',
    rating: 5,
    text: "Best headset I've ever owned. 40 hours of battery life is no joke — I charge it once a week.",
    product: 'Elite Headset X7',
    verified: true,
  },
  {
    name: 'Marcus T.',
    avatar: '🧑‍🔬',
    rating: 5,
    text: 'This monitor at 240Hz is buttery smooth. Coming from 144Hz, the difference is night and day.',
    product: 'Gaming Monitor 27"',
    verified: true,
  },
  {
    name: 'Jess L.',
    avatar: '👩‍💻',
    rating: 4,
    text: 'Precision Mouse is so light it feels like nothing in my hand. My aim has genuinely improved.',
    product: 'Precision Mouse Pro',
    verified: true,
  },
];
...
export default function VoltStoreDemo() {
  ...
  const heroProducts = products.filter(
    (p) => p.badge === 'New' || p.badge === 'Bestseller' || p.badge === 'Sale',
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white selection:bg-lime-400/30 selection:text-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-lime-500 via-green-500 to-emerald-500 text-black">
        <div
          className="absolute inset-0 bg-[linear-gradient(90deg,transparent_0%,rgba(255,255,255,0.15)_50%,transparent_100%)] animate-[shimmer_2s_infinite]"
        ...
        <div className="max-w-7xl mx-auto px-6 py-2.5 flex items-center justify-center gap-3 text-sm font-bold relative z-10">
          ...
          <span className="hidden sm:inline font-mono bg-black/10 px-2 py-0.5 rounded text-xs">
            VOLT40
          </span>
      ...
      <nav className="sticky top-0 z-40 backdrop-blur-2xl bg-slate-950/80 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-lime-400 to-green-500 flex items-center justify-center text-black font-black text-sm">
                V
              </div>
            ...
            <div className="hidden lg:flex items-center gap-1 text-sm">
              {['Products', 'Categories', 'Deals', 'Reviews'].map((item) => (
                <a
                  ...
                  className="px-4 py-2 rounded-lg hover:bg-white/5 hover:text-lime-400 transition-all duration-200 font-medium"
                >
                  {item}
                </a>
              ))}
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                className="relative p-2.5 rounded-lg hover:bg-white/5 transition group"
                onClick={() => setCartOpen(!cartOpen)}
              >
                <svg
                  className="w-5 h-5 text-slate-300 group-hover:text-lime-400 transition"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={1.5}
                ...
                {cartCount > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 w-5 h-5 bg-lime-400 text-black text-[10px] font-black rounded-full flex items-center justify-center animate-[bounceIn_0.3s_ease]">
                    {cartCount}
                  </span>
                )}
              </button>
        ...
        {cartOpen && (
          <div
            className="absolute right-4 top-full mt-2 w-80 bg-slate-900/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black mb-6 leading-[0.95] tracking-tight">
                ...
                <span className="block text-slate-400 text-2xl sm:text-3xl lg:text-4xl font-bold mt-2">
                  Engineered to Win
                </span>
              </h1>
              <p className="text-lg text-slate-400 mb-8 leading-relaxed max-w-lg">
                Pro-grade peripherals used by top esports teams. Precision-engineered for
                competitive gaming with zero compromises.
              </p>
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  href="#products"
                  className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-lime-400 to-green-500 text-black font-bold text-base rounded-xl hover:shadow-xl hover:shadow-lime-400/25 transition-all duration-300 active:scale-[0.97]"
                >
                  Shop Collection
                  <svg
            ...
            <div
              className={`relative transition-all duration-700 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
            >
              <div className="relative aspect-square max-w-md mx-auto">
                ...
                <div className="relative h-full rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-white/10 backdrop-blur-sm overflow-hidden">
                  ...
                  {heroProducts.map((p, i) => (
                    <div
                      key={p.id}
                      className={`absolute inset-0 flex flex-col items-center justify-center p-8 transition-all duration-700 ${i === heroIdx ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
                    >
                  ...
                  <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-2">
                    {heroProducts.map((_, i) => (
                      <button
                        ...
                        className={`w-2 h-2 rounded-full transition-all duration-300 ${i === heroIdx ? 'bg-lime-400 w-6' : 'bg-white/20 hover:bg-white/40'}`}
                      />
                    ))}
                  </div>
                </div>
              ...
              <div className="absolute -bottom-4 -left-4 bg-slate-900/90 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-xl">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-lime-400/10 flex items-center justify-center text-lime-400 text-lg">
                    ⚡
                  </div>
                  <div>
      ...
      <section id="categories" className="py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-end justify-between mb-10">
            ...
            <a
              href="#products"
              className="hidden sm:flex items-center gap-1 text-sm text-slate-400 hover:text-lime-400 transition"
            >
              View All <span>→</span>
            </a>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((cat) => (
              ...
              >
                ...
                <span className="font-bold text-sm group-hover:text-lime-400 transition">
                  {cat.name}
                </span>
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1 bg-white/5 rounded-xl p-1 border border-white/5">
                <button
                  ...
                  className={`px-3 py-1.5 text-xs font-bold rounded-lg transition ${activeCategory === 'all' ? 'bg-lime-400 text-black' : 'text-slate-400 hover:text-white'}`}
                >
                  All
                </button>
                {categories.slice(0, 4).map((c) => (
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-bold rounded-lg transition hidden md:block ${activeCategory === c.slug ? 'bg-lime-400 text-black' : 'text-slate-400 hover:text-white'}`}
                  >
                    {c.name}
                  </button>
                ))}
              ...
              <select
                ...
                className="bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-xs text-slate-300 focus:outline-none focus:border-lime-400/50 appearance-none cursor-pointer"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {filtered.map((product) => (
              ...
              >
                {product.badge && (
                  <div
                    className={`absolute top-3 left-3 z-10 px-2.5 py-1 text-[10px] font-black rounded-lg uppercase tracking-wider ${
                      product.badge === 'Sale'
                ...
                <div className="relative aspect-square bg-gradient-to-br from-white/[0.05] to-transparent overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/60 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-all duration-300">
                    <button
                      ...
                      className="px-4 py-2 bg-white text-black text-xs font-bold rounded-lg hover:bg-lime-400 transition transform translate-y-4 group-hover:translate-y-0 duration-300"
                    >
                      Quick View
                    </button>
                    <button
                      onClick={() => addToCart(product.id)}
                      className="p-2 bg-lime-400 text-black rounded-lg hover:bg-lime-300 transition transform translate-y-4 group-hover:translate-y-0 duration-300 delay-75"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
                ...
                <div className="p-4">
                  ...
                  <h3 className="font-bold text-sm mb-3 group-hover:text-lime-400 transition leading-tight">
                    {product.name}
                  </h3>
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() => addToCart(product.id)}
                      className="p-2 rounded-lg bg-white/5 hover:bg-lime-400 hover:text-black text-slate-400 transition-all duration-200"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
          ...
          {filtered.length === 0 && (
            <div className="text-center py-16 text-slate-500">
              ...
              <button
                onClick={() => setActiveCategory('all')}
                className="mt-3 text-lime-400 text-sm hover:underline"
              >
                View all products
              </button>
            </div>
      ...
      {quickView && (
        ...
        >
          ...
          >
            <button
              onClick={() => setQuickView(null)}
              className="absolute top-4 right-4 z-10 w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/20 transition"
            >
              ✕
            </button>
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 flex flex-col">
                {quickView.badge && (
                  <span className="self-start px-2.5 py-1 bg-lime-400/10 text-lime-400 text-[10px] font-bold rounded-lg uppercase mb-3">
                    {quickView.badge}
                  </span>
                )}
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm text-slate-400">
                    {quickView.rating} ({quickView.reviews.toLocaleString()} reviews)
                  </span>
                </div>
                ...
                <div className="mt-6 pt-4 border-t border-white/5">
                    ...
                    {quickView.oldPrice > 0 && (
                      <>
                        ...
                        <span className="text-xs font-bold text-red-400 bg-red-400/10 px-2 py-0.5 rounded">
                          SAVE ${quickView.oldPrice - quickView.price}
                        </span>
                      </>
                    )}
                  </div>
                  <button
                    ...
                    className="w-full py-3 bg-gradient-to-r from-lime-400 to-green-500 text-black font-bold rounded-xl hover:shadow-lg hover:shadow-lime-400/25 transition-all active:scale-[0.98]"
                  >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-lime-400/10 via-green-500/10 to-emerald-500/10 border border-lime-400/20 p-8 lg:p-12">
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <span className="inline-block px-3 py-1 bg-lime-400 text-black text-xs font-black rounded-lg mb-4">
                  LIMITED TIME
                </span>
                <h2 className="text-3xl lg:text-5xl font-black mb-4">
                  Bundle & Save
                  <br />
                  <span className="text-lime-400">Up to 40% OFF</span>
                </h2>
                <p className="text-slate-400 mb-6 max-w-md">
                  Get the complete gaming setup — keyboard, mouse, headset, and mousepad — at an
                  unbeatable price.
                </p>
              ...
              <div className="flex justify-center gap-4 text-center">
                {[
                  ...
                  <div
                    key={t.label}
                    className="w-20 p-3 bg-black/30 rounded-2xl border border-white/5"
                  >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {reviews.map((r, i) => (
              <div
                key={i}
                className="p-5 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-lime-400/20 transition-all duration-300"
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-bold text-sm flex items-center gap-2">
                      {r.name}
                      {r.verified && (
                        <span className="text-[9px] px-1.5 py-0.5 bg-lime-400/10 text-lime-400 rounded font-bold">
                          VERIFIED
                        </span>
                      )}
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div
                key={f.title}
                className="group p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-lime-400/20 text-center transition-all duration-300 hover:-translate-y-1"
              >
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-white/5 p-8 lg:p-16">
            ...
            <div className="relative max-w-2xl mx-auto text-center">
              ...
              <p className="text-slate-400 mb-6">
                Get exclusive early access, member-only deals, and pro gaming tips.
              </p>
              ...
              {subscribed ? (
                ...
                <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                  ...
                  <button
                    ...
                    className="px-6 py-3.5 bg-gradient-to-r from-lime-400 to-green-500 text-black font-bold text-sm rounded-xl hover:shadow-lg hover:shadow-lime-400/20 transition-all whitespace-nowrap active:scale-[0.97]"
                  >
                    Get 10% Off
                  </button>
                </div>
              ...
              <p className="text-[11px] text-slate-600 mt-4">
                Join 15,000+ gamers. Unsubscribe anytime. We respect your inbox.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 md:col-span-4 lg:col-span-1">
              ...
              <p className="text-xs text-slate-500 leading-relaxed mb-4">
                Premium gaming peripherals engineered for performance. Trusted by 50,000+ gamers
                worldwide.
              </p>
              <div className="flex gap-3">
                {['𝕏', 'in', 'yt', 'dc'].map((s) => (
                  <div
                    key={s}
                    className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-xs text-slate-400 hover:bg-lime-400/10 hover:text-lime-400 cursor-pointer transition"
                  >
                    {s}
                  </div>
                ))}
            ...
            {[
              {
                title: 'Shop',
                links: ['All Products', 'Keyboards', 'Mice', 'Audio', 'Monitors', 'Accessories'],
              },
              {
                title: 'Support',
                links: ['Help Center', 'Shipping Info', 'Returns', 'Warranty', 'Contact Us'],
              },
              ...
              <div key={col.title}>
                ...
                <ul className="space-y-2.5">
                  {col.links.map((link) => (
                    <li key={link}>
                      <a href="#" className="text-sm text-slate-500 hover:text-lime-400 transition">
                        {link}
                      </a>
                    </li>
                  ))}
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-8 py-6 border-y border-white/5">
            {['visa', 'mastercard', 'amex', 'paypal', 'apple pay', 'google pay'].map((p) => (
              <div
                key={p}
                className="px-3 py-1.5 bg-white/5 rounded-lg text-[10px] text-slate-400 uppercase tracking-wider font-bold"
              >
                {p}
              </div>
            ))}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center">
            <p className="text-xs text-slate-600">
              © 2026 VoltStore. All rights reserved. This is a demo website.
            </p>
            <Link
              href="/#web-design"
