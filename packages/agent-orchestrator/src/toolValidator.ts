 ...
 */
type ValidatorFn = (args: unknown) => { ok: true; parsed: unknown } | { ok: false; errors: string[] };
...
export function validateToolArgs(name: string, args: unknown): { ok: true; parsed: unknown } | { ok: false; errors: string[] } {
