...
export const ChatWidget: React.FC<ChatWidgetProps> = ({ apiUrl = '/api/v1/agents/customer-service/run', workspaceId = 'demo' }) => {
  ...
  return (
    <div style={{ width: 340, border: '1px solid #ddd', borderRadius: 8, padding: 12, fontFamily: 'Inter, system-ui, sans-serif' }}>
