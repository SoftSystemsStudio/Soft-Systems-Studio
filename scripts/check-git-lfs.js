...
function checkGitLfs() {
  ...
  console.error('If you plan to push from this environment (devcontainer or host), install git-lfs and run `git lfs install --system`.');
  console.error('\nInstallation examples:');
  console.error('  Debian/Ubuntu (host or container):');
  console.error('    curl -s https://packagecloud.io/install/repositories/github/git-lfs/script.deb.sh | sudo bash');
