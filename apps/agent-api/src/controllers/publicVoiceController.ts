...
export async function publicVoiceController(req: Request, res: Response) {
  ...
  let aiReply =
    'Hello! This is the automated receptionist for Prattville Midwifery. How can I help you today?';
  ...
  try {
    ...
    twiml.say(
      { voice: 'alice' },
      "I'm sorry, I'm having trouble connecting to the brain. Please try again later.",
    );
  }
